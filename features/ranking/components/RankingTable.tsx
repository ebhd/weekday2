...
export function RankingTable() {
  ...
  return (
    <div className="rounded-3xl text-white bg-linear-to-b from-accent/40 to-secondary/40 border border-muted-fg backdrop-blur-md shadow-lg shadow-black/20 overflow-hidden font-sans">
      {/* HEADER */}
      <div className={`${grid} px-8 py-4 text-sm text-white/60 bg-black/20`}>
